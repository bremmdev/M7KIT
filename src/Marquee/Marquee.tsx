...
export const Marquee = (props: MarqueeProps) => {
  const { animationDuration = 5000, children, className, direction = "left", pauseOnHover = true, ...rest } = props;
  ...
  const animationClass = isVertical ? "animate-marquee-vertical" : "animate-marquee-horizontal";

  return (
    <div
      {...rest}
      className={cn("flex overflow-hidden gap-8 p-8 group bg-surface-subtle", className, {
      ...
      {duplicatedChildren.map((c, idx) => {
        return (
          <div
            ...
            className={cn(`flex justify-center gap-8 ${animationClass} shrink-0`, {
