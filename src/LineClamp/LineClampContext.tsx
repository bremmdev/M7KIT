...
export const LineClampContext = React.createContext<LineClampContextType | undefined>(undefined);

export const LineClampProvider = ({ children }: { children: React.ReactElement<any> }) => {
